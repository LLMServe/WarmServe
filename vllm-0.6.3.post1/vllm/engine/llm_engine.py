...
class LLMEngine:
    ...
    def __init__(
        ...
        time_1 = time.time()
        logger.debug(f"init tokenizer and input_processor time cost = {'%.2f' % (time_1 - stime)} seconds")
        ...
        time_2 = time.time()
        logger.debug(f"init executor time cost = {'%.2f' % (time_2 - time_1)} seconds")

        if not self.model_config.embedding_mode:
            self._initialize_kv_caches()
        
        time_3 = time.time()
        logger.debug(f"init kv cache time cost = {'%.2f' % (time_3 - time_2)} seconds")
        ...
        logger.debug(f"check tokenizer: report usage time cost = {'%.2f' % (time.time() - time_3)} seconds")
        ...
        time_4 = time.time()
        logger.debug(f"check tokenizer time cost = {'%.2f' % (time_4 - time_3)} seconds")
        ...
        time_5 = time.time()
        logger.debug(f"init scheduler time cost = {'%.2f' % (time_5 - time_4)} seconds")
        ...
        time_6 = time.time()
        logger.debug(f"init logger time cost = {'%.2f' % (time_6 - time_5)} seconds")
        ...
        time_7 = time.time()
        logger.debug(f"init output_processor time cost = {'%.2f' % (time_7 - time_6)} seconds")
        logger.debug(f"total initialization time cost = {'%.2f' % (time_7 - stime)} seconds")
    ...
    def _initialize_kv_caches(self) -> None:
        ...
        time_1 = time.time()
        logger.debug(f"_initialize_kv_caches: determine_num_available_blocks time cost = {'%.2f' % (time_1 - stime)} seconds")

        self.model_executor.initialize_cache(num_gpu_blocks, num_cpu_blocks)

        time_2 = time.time()
        logger.debug(f"_initialize_kv_caches: initialize_cache time cost = {'%.2f' % (time_2 - time_1)} seconds")
